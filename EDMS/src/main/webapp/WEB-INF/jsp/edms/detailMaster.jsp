...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags"%>
	...
	<script src="<c:url value='/js/sein/edms/detailMaster.js'/>"></script>
  </head>
  <body>
          ...
          <div class="panel panel-primary">
            ...
            <div class="panel-body well-sm" id='parentDiv'>
              <div class="well well-sm text-center" id="saveTxt" style="display:none">
                <font color="red">반출완료된 건은 수정하실 수 없습니다.</font>
              </div>
			  ...
			  <table class="table table-striped table-bordered">
				...
				<col width="80%" />
		      	...
		      	<tr>
		      	  <td class="info">H B/L</td>
		      	  <td>
		      	  	<input type="text" id="edmsNum" name="edmsNum" class="input-sm" readOnly/>
		      	  </td>
		      	</tr>
		      	<tr>
		     	  <td class="info">분할여부</td>
		     	  <td>
		  	  	  	<select id="divisionSingoYn" name="divisionSingoYn" class="input-sm" style="width:40px;">
		      	...
		      	<tr>
		      	  ...
		      	  <td>
		      	  	<input type="text" id="singoNum" name="singoNum" class="input-sm" class="wp95"/>
		      	  </td>
		      	</tr>
		       	<tr>
		     	  <td class="info">입항일</td>
		     	  <td>
		  	  	  	<input type="text" id="iphangDay" name="iphangDay" class="input-sm" maxlength="8" onkeydown="return showKeyCode(event)"/>
		     	  </td>
		      	</tr>
		      	<tr>
		     	  <td class="info">반입일</td>
		     	  <td>
		  	  	  	<input type="text" id="banipDay" name="banipDay" class="input-sm" maxlength="8" onkeydown="return showKeyCode(event)"/>
		     	  </td>
		      	</tr>
		      	<tr>
		      	...
		      	<tr>
		     	  <td class="info">반출일</td>
		     	  <td>
		  	  	  	<input type="text" id="banchulDay" name="banchulDay" class="input-sm" maxlength="8" onkeydown="return showKeyCode(event)"/>
		     	  </td>
		      	</tr>
		      	</tbody>
		 	  </table>
