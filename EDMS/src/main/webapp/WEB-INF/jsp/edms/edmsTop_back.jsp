...
<%@ include file="/WEB-INF/jsp/include/head_titleIndex.jsp" %>
  ...
  <body bgcolor="#2763ba">
    <div id="container">
	  ...
	  <ul class="menu4">|<font color="yellow"><span id="timer"></span></font><a onclick="refreshTimer();"><font color="yellow">[연장]</font></a> | <a onclick="View0()"><font color="white">Home</font></a> | <a onclick="View2()"><font color="white">Notice</font></a> | <a onclick="View1()"><font color="white">Setting</font></a> | <a onclick="Logout()"><font color="white">Logout</font></a> |</ul>
