...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags"%>
	...
	<script src="<c:url value='/js/sein/board/boardInsert.js'/>"></script>
  ...
  <body>
          ...
          <div class="panel panel-primary">
            <div class="panel-heading">
              ...
              <div class="pull-right">
                <button type="button" class="btn btn-default btn-xs" onclick="fnCheckInput()">등록</button>
            ...
            <div class="panel-body well-sm">
              <form name="tx_editor_form" id="tx_editor_form" accept-charset="utf-8">
				...
				<input type="hidden" id="noticesKey" 		name="noticesKey" 		value="" />
				<input type="hidden" id="fileAttachedYn" 	name="fileAttachedYn" 	value="N" />
				...
				<table class="table table-bordered">
				  ...
				  <tr>
					...
					<td>
					  ...
					  <textarea name="contents" id="contents" rows="10" cols="100" style="width:790px; height:600px;display: none;"></textarea>
					</td>
				  </tr>
				</table>
	...
	<script type="text/javascript">
		var config = {
			...
			size: {
				contentWidth: 790 /* 지정된 본문영역의 넓이가 있을 경우에 설정 */
			}
		};
